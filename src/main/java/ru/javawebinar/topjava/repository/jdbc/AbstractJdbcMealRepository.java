...
public abstract class AbstractJdbcMealRepository implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", addDateTime(meal))
...
//                ROW_MAPPER, userId, startDateTime, endDateTime);
                ROW_MAPPER, userId, convertToIdentifiedDateTime(startDateTime), convertToIdentifiedDateTime(endDateTime));
    }

    abstract <T> T addDateTime(Meal meal);

    abstract <T> T convertToIdentifiedDateTime(LocalDateTime dateTime);
}
